/* 
LSM9DS0_MS5611_t3 Basic Example Code
 by: Kris Winer
 ...
 This sketch is intended specifically for the LSM9DS0+MS5611 Add-on shield for the Teensy 3.1.
 ...
 4K7 resistors are on the LSM9DS0+MS5611 Teensy 3.1 add-on shield/breakout board.
...
// Using the LSM9DS0+MS5611 Teensy 3.1 Add-On shield, ADO is set to 0 
#define ADO 0
#if ADO
